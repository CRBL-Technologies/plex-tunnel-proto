...
func TestMessageValidate(t *testing.T) {
	tests := []struct {
		...
		{name: "register ok", msg: Message{Type: MsgRegister, Token: "abc", ProtocolVersion: ProtocolVersion}},
		{name: "register missing token", msg: Message{Type: MsgRegister, ProtocolVersion: ProtocolVersion}, wantErr: true},
		{name: "register missing protocol version", msg: Message{Type: MsgRegister, Token: "abc"}, wantErr: true},
		{name: "register ack ok", msg: Message{Type: MsgRegisterAck, Subdomain: "foo", ProtocolVersion: ProtocolVersion}},
		{name: "register ack missing subdomain", msg: Message{Type: MsgRegisterAck, ProtocolVersion: ProtocolVersion}, wantErr: true},
		{name: "register ack missing protocol version", msg: Message{Type: MsgRegisterAck, Subdomain: "foo"}, wantErr: true},
