...
func TestMessageValidate(t *testing.T) {
	tests := []struct {
		...
		{name: "register legacy version shape still valid", msg: Message{Type: MsgRegister, Token: "abc", ProtocolVersion: 1}},
		...
		{name: "register ack legacy version shape still valid", msg: Message{Type: MsgRegisterAck, Subdomain: "foo", ProtocolVersion: 1}},
