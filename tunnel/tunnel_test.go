...
func TestMessageValidate(t *testing.T) {
	tests := []struct {
		...
		{name: "http window update ok", msg: Message{Type: MsgHTTPWindowUpdate, ID: "stream-1", WindowIncrement: 65536}},
		{name: "http window update missing id", msg: Message{Type: MsgHTTPWindowUpdate, WindowIncrement: 65536}, wantErr: true},
		{name: "http window update zero increment", msg: Message{Type: MsgHTTPWindowUpdate, ID: "stream-1"}, wantErr: true},
		{name: "cancel ack ok", msg: Message{Type: MsgCancelAck, ID: "stream-1"}},
		{name: "cancel ack missing id", msg: Message{Type: MsgCancelAck}, wantErr: true},
		{name: "frame delivered ok", msg: Message{Type: MsgFrameDelivered, ID: "stream-1", AckedSeq: 5}},
		{name: "frame delivered terminal ok", msg: Message{Type: MsgFrameDelivered, ID: "stream-1", AckedSeq: 42, StreamTerminal: true}},
		{name: "frame delivered zero seq ok", msg: Message{Type: MsgFrameDelivered, ID: "stream-1"}},
		{name: "frame delivered missing id", msg: Message{Type: MsgFrameDelivered, AckedSeq: 5}, wantErr: true},
